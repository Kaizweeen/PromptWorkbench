/**
 * Prompts, versions, and stack presets.
 *
 * The invariant this file protects: versions are immutable. Every save
 * inserts a new numbered version; restore and fork both create new versions
 * rather than rewriting old ones, so history is never lost.
 */
